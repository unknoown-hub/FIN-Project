"""
Variant 4 of FINd: vectorised hash bit assignment in dctOutput2hash.
...
class FINDHasher_v4_hash:
	...
	def dctOutput2hash(self, dctOutput16x16):
		...
		# Vectorised threshold: same strict > comparison as original
		hash_bits = (arr > dctMedian).astype(int)

		# The original writes hash[15-i, 15-j] — equivalent to
		# reversing both axes
